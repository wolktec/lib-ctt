...
import createPerformanceIndicators from "../microservice/parcial/performanceIndicators";
import mock from "../mock";

createAvailabilityAllocation(
  mock.equipments,
  mock.events,
  "18-12-2024 18:57:56",
  []
...
createPerformanceIndicators(
  mock.equipmentProductivity,
  mock.events,
  mock.equipments,
  mock.idleEvent,
  mock.hourMeterTelemetry,
  [],
  mock.workFronts,
  []
)
