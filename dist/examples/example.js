...
const performanceIndicators_1 = __importDefault(require("../microservice/parcial/performanceIndicators"));
...
(0, performanceIndicators_1.default)(mock_1.default.equipmentProductivity, mock_1.default.events, mock_1.default.equipments, mock_1.default.idleEvent, mock_1.default.hourMeterTelemetry, [], mock_1.default.workFronts, [])
    .then((result) => {
    console.log("PartialDelivered:", JSON.stringify(result, null, 2));
})
    .catch((error) => {
