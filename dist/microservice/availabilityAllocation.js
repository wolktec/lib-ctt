...
class availabilityAllocation {
    constructor() {
        this.createAvailabilityAllocation = async (equipments, events) => {
         ...
         */
        this.sumEquipmentsByGroup = async (equipments, events) => {
         ...
         * @param interferences
         */
        this.getMechanicalAvailability = async (interferences, currentHour) => {
        ...
        this.formatAvailabilityReturn = async (groupedEquipments) => {
