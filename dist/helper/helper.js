...
exports.groupTelemetryByEquipmentCode =
  exports.getDefaultHoursData =
  exports.getHarvesterEvents =
  exports.getHarvestDateRange =
  exports.getDaysBetweenDates =
  exports.getDaysInMonth =
  exports.calcJourneyByFront =
  exports.convertSecondstoTimeString =
  exports.createValueWithGoal =
  exports.getTotalHourmeter =
  exports.calcTotalInterferenceByFront =
  exports.calcJourney =
  exports.calcTelemetryByFront =
  exports.groupEquipmentTelemetryByFront =
  exports.secToTime =
  exports.msToTime =
...
const dateFilter = (start_date, splitSeparator = "/") => {
  const dt1 = (0, exports.dateParts)(
    start_date ??
      (0, dayjs_1.default)().subtract(3, "hours").format("DD/MM/YYYY"),
    splitSeparator
  );
...
const groupEquipmentTelemetryByFront = (equipments, telemetry) => {
  ...
  const telemetryHourmeterByEquipment = (0,
  exports.groupTelemetryByEquipmentCode)(telemetry);
  for (const equipment of equipments) {
    ...
    const totalHourmeter = normalizeCalc(
      (0, exports.getTotalHourmeter)(telemetryData),
      2
    );
...
const calcTotalInterferenceByFront = (
...
const createValueWithGoal = (
  value,
  hasTotalField = false,
  hasAverageField = false
) => {
  return {
